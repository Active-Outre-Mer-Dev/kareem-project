...
export default function Page() {
  ...
  return (
    <Card className="bg-neutral-50 w-4/5 ring-0 fixed top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4">
      {" "}
      ...
      <h1 className="text-2xl font-heading font-medium text-center mb-2">Email sent!</h1>
      ...
      <Link
        ...
        className={buttonStyles({ size: "sm", className: "rounded-full" })}
      >
        Another one
      </Link>
    </Card>
